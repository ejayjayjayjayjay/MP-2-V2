...
function purchaseClicked() {
    ...
    var cartItems = document.getElementsByClassName('cart-meals')[0]
...
function addItemToCart(title, price, imageSrc) {
    ...
    var cartItems = document.getElementsByClassName('cart-meals')[0]
    var cartItemNames = cartItems.getElementsByClassName('cart-meal-title')
    ...
    var cartRowContents = `
        <div class="cart-meal cart-column">
            <img class="cart-meal-image" src="${imageSrc}" width="100" height="100">
            <span class="cart-meal-title">${title}</span>
        </div>
...
function updateCartTotal() {
    var cartItemContainer = document.getElementsByClassName('cart-meals')[0]
